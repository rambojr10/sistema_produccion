// ----------------------------------------------------------------------------------------------------------
    ...
    .then(res => {
        var data = [
            {
                descripcion:  `12 Semanas ${res.cintas[0].cinta}` ,
                lunes: '0',
                martes: '0',
                miercoles: '0',
                jueves: '0',
            ...
            {
                descripcion: `11 Semanas ${res.cintas[1].cinta}`,
                lunes: '0',
                martes: '0',
                miercoles: '0',
                jueves: '0',
            ...
            {
                descripcion: `10 Semanas ${res.cintas[2].cinta}`,
                lunes: '0',
                martes: '0',
                miercoles: '0',
                jueves: '0',
            ...
            {
                descripcion: `09 Semanas ${res.cintas[3].cinta}`,
                lunes: '0',
                martes: '0',
                miercoles: '0',
                jueves: '0',
    ...
    // Renderers here ---------------------------------------------------------------------------------------------------------
        ...
        coffeeRenderer = function(instance, td, row, col, prop, value, cellProperties) {
            ...
            td.style.backgroundColor = 'coffee';
        ...
        // Recibe las cintas para clasificarlas según el color y así renderizarlas en los td
    ...
    // ------------------------------------------------------------------------------------------------------------------------
        ...
        var tblSettings = {
            ...
            className: 'htCenter',
            cell: [
                {row: 0, col: 0, renderer: renderizarCintas(res.cintas[0].cinta) },
                {row: 1, col: 0, renderer: renderizarCintas(res.cintas[1].cinta) },
                {row: 2, col: 0, renderer: renderizarCintas(res.cintas[2].cinta) },
                {row: 3, col: 0, renderer: renderizarCintas(res.cintas[3].cinta) },
