...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-08-2019 a las 15:42:11
...
CREATE TABLE `tbldet_tblproduccion` (
  ...
  `Total_CE_Dias` int(11) DEFAULT NULL,
...
INSERT INTO `tbldet_tblproduccion` (`PKId`, `FKId_TblProduccion`, `FKId_TblDias`, `Total_CE_Dias`, `Total_CR_Dia`, `Total_CEx_Dia`, `Ratio`, `Merma`, `Peso_Racimos`, `Area_Recorrida`, `Peso_Vastago`) VALUES
