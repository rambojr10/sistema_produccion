...
<div class="container">
    <div class="panel panel-success text-center">
        ...
        <div class="panel-body">
            ...
            <button type="button" class="btn btn-success notika-btn-success waves-effect">Ingresar</button>
        </div>
    </div>
    ...
    <div class="panel panel-primary text-center">
        ...
        <div class="panel-body">
            ...
            <p class="card-text">Última semana registrada: <span class="label label-warning">31</span></p>
            <button type="button" class="btn btn-primary notika-btn-primary waves-effect">Ingresar</button>
        </div>
    </div>
    ...
    <div class="panel panel-danger text-center">
        ...
        <div class="panel-body">
            ...
            <p class="card-text">Última semana registrada: <span class="label label-warning">31</span></p>
            <button type="button" class="btn btn-danger notika-btn-danger waves-effect">Ingresar</button>
        </div>
    </div>
</div>